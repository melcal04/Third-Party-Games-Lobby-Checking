...
export class AllBetPage extends PageHelper {
  ...
  async extractLobbyData(): Promise<Record<string, any>> {
    ...
    const categories: Locator = this.page.locator("div.game_name");
  ...
  async getTables(): Promise<string[]> {
    const tableNames: Locator = this.page.locator("article.game_table_collection div.table_info");
